...
- (void)config {
    ...
    //2.指定MessageHandler
    {
        [self.configuration.userContentController addScriptMessageHandler:[[KLWKScriptMessageHandler alloc] init] name:@"WKNativeMethodMessage"];
    }
